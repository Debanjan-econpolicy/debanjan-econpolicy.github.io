...
************************************************************************************************************
*** This file provides adjusted q-values for main outcomes on business practices and firm outcomes *********
************************************************************************************************************
...
** Append together the p-values from Tables 4 and 5 by treatment ******	
use "$constructdata/Tablep4.dta", clear
append using "$constructdata/Tablep5.dta"
save "$constructdata/Nigeriamainpvals.dta", replace


*** Insourcing *****

use "$constructdata/Nigeriamainpvals.dta", clear
version 10
keep if treatment==1
...
save "$constructdata/adjustedmainqvals.dta", replace
...
keep table column treatment round pval bky06_qval
append using "$constructdata/adjustedmainqvals.dta"
save "$constructdata/adjustedmainqvals.dta", replace
...
***************************************************************
**** Appendix Table 9.1: Adjusted Q-values for Main Effects ***
***************************************************************
use "$constructdata/adjustedmainqvals.dta", clear
...
label define tabcollab 41 "Finance & Accounting Practices" 42 "Marketing & Sales Practices" 43 "Operations & HR Practices" ///
44 "Verified Traditional Practices" 45 "Verified Digital Practices" 46 "Overall Index of Business Practices" ///
51 "I.H.S. Monthly Sales" 52 "I.H.S. Yearly Sales" 53 "I.H.S. Monthly Profits" 54 "I.H.S. Yearly Profits" ///
55 "Sales & Profits Index" 56 "Total Employment" 57 "I.H.S. Employment"
label values tablecolumn tabcollab
drop column
format pval %9.4f
format bky06_qval %9.3f
order table tablecolumn treatment round pval bky06_qval
export excel using "$tables/TableA9_1.xls", firstrow(variables) keepcellfmt replace
